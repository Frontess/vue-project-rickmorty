  ...
  <div>
    ...
    <div className="cards">
      <div className="card-item" v-for="character in filteredCharacters" :key="character.id">
       <div className="card-image"><img :src="character.image" alt="Character Image" />
       </div>
...
<!-- <template>
  ...
  <div v-for="character in filteredCharacters" :key="character.id">
      ...
      <!-- Другие свойства персонажа, например, изображение, вид и т. д. -->
    <!-- </div>
    <div className="cards">
      
        <!-- <div className="card-item" v-for="(item, index) in data" :key="index"> -->
          ...
          <!-- <div className="card-item" v-for="character in filteredCharacters" :key="character.id">
            ...
            <div className="card-content">
                ...
                <p className="card-gender">{{item.gender}}</p>
            </div>
        </div>
    </div>
